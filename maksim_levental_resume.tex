...
\hfill \textbf{Oct. 2020 --- Present}
\begin{itemize}
\item Building an end-to-end open-source flow from PyTorch to FPGA, using MLIR, LLVM, and Vitis HLS. Currently exploring affine loop transformations and AXIS interconnects.
...
\textbf{Submitted} to International Conference on Computational Science (ICCS '22).
\end{hangingpar}
