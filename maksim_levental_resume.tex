...
Broadly, I'm interested in using, improving and designing application-specific hardware accelerators for Deep Neural Networks (DNNs), for science applications. 
Specifically, using compiler techniques such as symbolic execution, and mathematical optimization techniques such as integer programming, to improve memory consumption and inference latencies of DNNs on GPUs and FPGAs. 
...
\item Helped develop a workflow that connects the Data and Learning Hub for Science (DLHub), a repository for publishing AI models, with the Hardware-Accelerated Learning (HAL) cluster, using funcX as a universal distributed computing service. Specifically, deployed auto-encoder models for identifying binary black hole mergers in LIGO data.
...
\textbf{Research Intern}, PyTorch, \emph{Facebook}
...
\item Developed a novel training paradigm using region-based stratified cross-validation that improved learning induction across disparate (in terms of geography) landmine data sets.
\item Research on Gaussian Processes (GP) for landmine detection. Specifically, modeling soil permittivity/dielectric changes as GP.
...
%\textbf{Undergraduate Researcher},  Magnetic Relaxometry Research Lab, MD Anderson 
%\hfill \textbf{Summer 2015}
%%\vspace{-6pt}
%\begin{itemize}
%\item Developed and tested physical models to characterize the decay of ferromagnetic nanoparticles for ovarian cancer detection system
%\end{itemize}
...
%\section{\mysectionstyle{LEADERSHIP}}
%
%\textbf{Executive Member}, College of Natural Sciences Council, UT Austin 
%\hfill \textbf{Jan. 2016---May 2020}
%\begin{itemize}
%\item Represented the academic interests of students in the College through writing and passing legislation.
%\item Lead numerous data-driven projects to improve repsentation in the College.
%\end{itemize}
%
%\textbf{Volunteer}, Kids Who Code, UT Austin 
%\hfill \textbf{Aug. 2016---Feb. 2020}
%\begin{itemize}
%\item Volunteer weekly with 5th grade students at local Austin schools.
%\item Expose students to problem solving and critical thinking skills through computer science.
%\end{itemize}
...
Skills     & Deep Learning, Compilers, Hardware \\
Coursework & \textit{Computer Science}: Quantum Computing, Deep Learning Systems, \\
	   & $\qquad$ $\qquad$ $\qquad$ $\quad$ Analysis of Algorithms, Consensus and Economics, Automata \\
           ...
           & $\qquad$ $\quad$ \hspace{0.1ex} Statistical Mechanics, Nuclear Physics, Waves and Optics
\end{tabular}
...
Submitted to 16th USENIX Symposium on Operating Systems Design and Implementation (OSDI '22).
\end{hangingpar}
